...
<link rel="stylesheet"
	href="css/main.css?v=<%= System.currentTimeMillis() %>">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<a href="#">
								<div class="txt_wrap">
									<p>#PROMOTION</p>
									<strong>우리집 어린이를 위한 선물!</strong> <em>반려동물 용품 최대 50% 할인 기획전</em>
